...
<div class="entry-content">
  ...
  <h3 style = "font-family: District-Light, Helvetica;">The Informatics faculty draws information and inspiration from many sources. These are some books we find particularly influential.</h3></div>
  ...
  <div class="book_listing group">
	...
	<p class="book_amazon"> <a class = "gb_more" href="<?php echo $amazon_link; ?>" target="_blank">Amazon</a>
    ...
    <p class = "catergory_tags rex-terms"> <?php the_terms( $post->ID, 'category_tags');?></p>
    <p class = "age_group_tags rex-terms"> <?php the_terms( $post->ID, 'age_group_tags');?></p>
