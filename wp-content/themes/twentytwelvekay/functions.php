...

{
	...
	wp_enqueue_script(
		...
		get_template_directory_uri() . '/js/inf117.js',
...

{
    ...
    if (isset($query_string['author_name'])) $query_string['post_type'] = array('post','rex');
...
function save_title($my_post_title) {
        ...
        if ($_POST['post_type'] == 'rex') :

          $new_title = $_POST['book-select-title'];
